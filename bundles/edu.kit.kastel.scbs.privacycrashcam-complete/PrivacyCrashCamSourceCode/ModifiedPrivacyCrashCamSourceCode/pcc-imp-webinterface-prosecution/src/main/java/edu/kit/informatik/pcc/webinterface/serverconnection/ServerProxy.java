...
public class ServerProxy {
    ...
    public static String getAllVideos(String authenticationToken) {
    	Response response = get("videos/allVideos", authenticationToken, MediaType.APPLICATION_JSON);
        return (response == null) ? FAILURE : response.readEntity(String.class);
    }
    
    public static String getUserIdForVideoId(int videoId, String authenticationToken) {
    	Response response = get("videos/getUserIdForVideoId/" + videoId, authenticationToken, MediaType.APPLICATION_JSON);
        return (response == null) ? FAILURE : response.readEntity(String.class);
    }
    ...
    public static InputStream getMetaData(int videoId, int targetUserId, String authenticationToken) {
    	Form f = new Form();
    	f.param("videoId", Integer.toString(videoId));
    	f.param("targetUserId", Integer.toString(targetUserId));
    	
    	Response response = post(f, "videos/metadata/getMetaData", authenticationToken);
    ...
    public static InputStream downloadConfidentialVideo(int videoId, int userId, String authenticationToken) {
    	Form f = new Form();
    	f.param("videoId", Integer.toString(videoId));
    	f.param("userId", Integer.toString(userId));
    	
    	Response response = post(f, "videos/downloadConfidentialVideo", authenticationToken);
