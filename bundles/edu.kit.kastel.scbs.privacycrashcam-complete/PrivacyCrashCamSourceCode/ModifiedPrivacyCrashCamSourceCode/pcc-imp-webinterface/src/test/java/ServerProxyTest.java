...
public class ServerProxyTest {
    ...
    public void getVideosWrongAccountTest() {
        assertEquals(ServerProxy.getVideos(token), WRONGACCOUNT);
    }

    @Test
    public void videoInfoWrongAccountTest() {
        assertEquals(ServerProxy.videoInfo(VIDEOID, token), WRONGACCOUNT);
    }

    @Test
    public void videoDeleteWrongAccountTest() {
        assertEquals(ServerProxy.videoDelete(VIDEOID, token), WRONGACCOUNT);
    }
